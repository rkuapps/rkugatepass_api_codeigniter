			...
			if ($user)
			{
				...
				{/*
					...
					$mail = $this->phpmailerlib->load();
						...
						$mail->Mailer = "smtp"; 
						//$mail->SMTPDebug = 2;
						$mail->Host     = 'mail.jjasani.com';
						$mail->SMTPAuth = true;
						$mail->Username = 'support@app.gangamaiyacotton.com';
						$mail->Password = 'Test@123';
						$mail->SMTPSecure ='tls';
						$mail->Port     = '587';
					$mail->isHTML(true); 
					$mail->setFrom('support@app.gangamaiyacotton.com', $this->config->item('site_title', 'ion_auth'));
