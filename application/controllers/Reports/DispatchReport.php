...
class DispatchReport extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if (!check_role_assigned('dispatch_report', 'view')) {
            redirect('forbidden');
        }
        ...
        $params['DispatchReport'] = $this->REPORT->getDispatchReport($searchtxt);

        //print_r($params['DispatchReport']);
        $this->load->view('Reports/DispatchReport/index', $params);
    }
}
