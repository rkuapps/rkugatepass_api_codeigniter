...
class CustomerManagement extends CI_Controller
{
	...
	public function index()
	{
		...
		$params['CustomerManagement'] = $this->setting_model->getCustomerManagement($companyid,$searchtxt);
		...
		$this->load->view('Settings/CustomerManagement/index', $params);
	}
	...
	public  function add($id = 0)
	{
		try {
			...
			$this->load->view('Settings/CustomerManagement/add', $params);
		} catch (Exception $e) {
			echo $e;
		}
	}
	...
	public  function addPerson($customerid=0,$id = 0)
	{
		...
		try {
			...
			$this->load->view('Settings/CustomerManagement/addPerson', $params);
		} catch (Exception $e) {
			echo $e;
		}
	}
	...
	public function save()
	{
		...
		return redirect('Settings/CustomerManagement/addPerson/'.$pid);
	}
	...
	public function savePerson()
	{
		...
		if ($this->form_validation->run()) {
			...
			return redirect('Settings/CustomerManagement/addPerson/'.$customerid);		
		}
	...
	public function saveItem()
	{
		...
		if ($this->form_validation->run()) {
			...
			return redirect('Settings/CustomerManagement/addItem/'.$customerid);		
		}
	...
	public function delete($id)
	{
		...
		return redirect('Settings/CustomerManagement/');
	}
