...
$pageBack=base_url()."Settings/CompanyManagement/";
    $addPerson=base_url()."Settings/CompanyManagement/addPerson/";
    $addPage=base_url()."Settings/CompanyManagement/add/";
    $deletePage=base_url()."Settings/CompanyManagement/Delete/";
    $addButton="Add";
        ...
        <section id="content_wrapper">
            ...
            <section id="content" class="table-layout animated fadeIn">
              ...
              $i=1;
                ...
                foreach($CompanyManagement as $post)
                {
                ?>
                ...
                if (check_role_assigned('company_master', 'edit')) {
                    echo "<div class='btn-group'>".anchor($addPerson . $post->id, '<i class="fa fa-address-card"></i>', ['title'=>'Edit Company Person' ,'class' => 'btn btn-info btn-xs', 'style' => 'float:left; margin-right:5px; margin-top:1px;']);
                  echo '</div>';
                }
                  if (check_role_assigned('company_master', 'edit')) {
                      echo "<div class='btn-group'>".anchor($addPage . $post->id, '<i class="fa fa-edit"></i>', ['title'=>'Edit Company' ,'class' => 'btn btn-primary btn-xs', 'style' => 'float:left; margin-right:5px; margin-top:1px;']);
                    echo '</div>';
                  }
