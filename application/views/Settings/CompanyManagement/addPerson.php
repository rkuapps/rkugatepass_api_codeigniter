<?php 
  ...
  $PageSave=base_url()."Settings/CompanyManagement/savePerson";
  $pageBack=base_url()."Settings/CompanyManagement/";
  $operation = "Add";
  ...
  if ($id != "" and is_numeric($id)) {
      ...
      $val_email= StringRepair3($companyperson->email);
      $val_name= StringRepair3($companyperson->name);
      $val_designation= StringRepair3($companyperson->designation);
      $val_number= StringRepair3($companyperson->contact_no);
      $val_status= StringRepair3($companyperson->status);
                    ...
                    ?>
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                ...
                                <li >
                                    <a href="<?=base_url('Settings/CompanyManagement/add/'.$companyid)?>">Company Details</a>
                                </li>
                                <?php 
                                if($companyid!=0 && $companyid!=""):
                                ?>
                                <li class="active">
                                    <a href="<?=base_url('Settings/CompanyManagement/addPerson/'.$companyid)?>" id="item-palleting-tab">Contact Person</a>
                                </li>
                                <?php endif;?>
                            </ul>
                                </span>
                            ...
                            <div class="panel-body">
                                <?php 
                                    ...
                                    phonebox('2','Contact Number','number','Enter Contact Number',$val_number);
                                ...
                                ?>
                                    ...
                                    <table class="table table-hover">
                                       ...
                                       <td><?=$status?></td>
                                            ...
                                            <td>
                                                    <div class=btn-group><a href='<?=base_url('Settings/CompanyManagement/addPerson/'.$companyid."/".$post->id)?>' class='btn btn-warning btn-xs'><span class='fa fa-edit'></span></a>
                                                                                        </div>
          ...
          swal({
                ...
                function(isConfirm) {
                    if (isConfirm) {
                         ...
                         window.location.href='<?=base_url('Settings/CompanyManagement/deletePerson/'.$companyid.'/')?>'+id;
