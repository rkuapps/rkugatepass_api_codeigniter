...
$addPage=base_url()."Settings/ItemCategory/add/";
$deletePage=base_url()."Settings/ItemCategory/Delete/";
$addButton="Add";
?>
<!DOCTYPE html>
<html>
    ...
    <div id="main">
        ...
        <section id="content_wrapper">
            <header id="topbar">
                ...
                <?php  if (check_role_assigned('item_category','add')) {?>
                                ...
                                <div class="panel-body pn">
                                    <table class="table table-hover" id="datatable">
                                        <thead>
                                            <tr>
                                                <th class="w20">#</th>
                                                <th style='width:150px !important'>Category Name</th>
                                                <th>Description</th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php 
                                                if (check_role_assigned('item_category', 'edit')) {
                                                    echo "<div class='btn-group'>".anchor($addPage . $post->id, '<i class="fa fa-edit"></i>', ['title'=>'Edit Item Category','class' => 'btn btn-warning btn-xs', 'style' => 'float:left; margin-right:5px; margin-top:1px;']);
                                                    echo '</div>';
                                                }
                                                if (check_role_assigned('item_category', 'delete')) {
                                                    echo '<div class="btn-group"><a href="#" onclick="javascript:deleteBox(' . $post->id . ')" title="Delete Item Category" class="btn btn-danger btn-xs cancel "><span class="fa fa-trash-o"></span></a>';
                                                    echo '</div>';
                                                }
                                                ?>
                                                </td>
