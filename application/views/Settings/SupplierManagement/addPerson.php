<?php 
  ...
  $PageSave=base_url()."Settings/SupplierManagement/savePerson";
  $pageBack=base_url()."Settings/SupplierManagement/";
  $operation = "Add";
                    ...
                    ?>
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                ...
                                <li >
                                    <a href="<?=base_url('Settings/SupplierManagement/add/'.$customerid)?>">Customer Details</a>
                                </li>
                                <?php 
                                if($customerid!=0 && $customerid!=""):
                                ?>
                                <li class="active">
                                    <a href="<?=base_url('Settings/SupplierManagement/addPerson/'.$customerid)?>" id="item-palleting-tab">Contact Person</a>
                                </li>
                                <?php endif;?>
                            </ul>
                                </span>
          ...
          swal({
                ...
                function(isConfirm) {
                    if (isConfirm) {
                         ...
                         window.location.href='<?=base_url('Settings/SupplierManagement/deletePerson/'.$customerid.'/')?>'+id;
