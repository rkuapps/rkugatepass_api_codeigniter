<?php 
  ...
  $PageSave=base_url()."Settings/SupplierManagement/save";
  $pageBack=base_url()."Settings/SupplierManagement/";
  $operation = "Add";
  $val_countryid=1;
  $val_state=24;
    ...
    ?>
        ...
        <div class="panel">
            <div class="panel-heading">
                ...
                <li class="active">
                    <a href="<?=base_url('Settings/SupplierManagement/')?>">Supplier Details</a>
                </li>
                <?php 
                if($id!=0 && $id!=""):
                ?>
                <li>
                <a href="<?=base_url('Settings/SupplierManagement/addPerson/'.$id)?>" id="item-palleting-tab">Contact Person</a>
                </li>
                <?php endif;?>
            </ul>
                </span>
            ...
            <div class="panel-body">
                                <?php 
                                    ...
                                    editbox('12','Supplier','customer_name','Enter Supplier Name',$val_customer_name,'required');
