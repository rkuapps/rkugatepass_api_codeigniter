<?php 
  ...
  $PageSave=base_url()."Settings/CustomerManagement/savePerson";
  $pageBack=base_url()."Settings/CustomerManagement/";
  $operation = "Add";
                    ...
                    ?>
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                ...
                                <li >
                                    <a href="<?=base_url('Settings/CustomerManagement/add/'.$customerid)?>">Customer Details</a>
                                </li>
                                <?php 
                                if($customerid!=0 && $customerid!=""):
                                ?>
                                <li class="active">
                                    <a href="<?=base_url('Settings/CustomerManagement/addPerson/'.$customerid)?>" id="item-palleting-tab">Contact Person</a>
                                </li>
                                <?php endif;?>
                            </ul>
                                </span>
                                ...
                                ?>
                                    ...
                                    <table class="table table-hover">
                                       ...
                                       <td><?=$status?></td>
                                            ...
                                            <td>
                                                    <div class=btn-group><a href='<?=base_url('Settings/CustomerManagement/addPerson/'.$customerid."/".$post->id)?>' class='btn btn-warning btn-xs'><span class='fa fa-edit'></span></a>
                                                                                        </div>
          ...
          swal({
                ...
                function(isConfirm) {
                    if (isConfirm) {
                         ...
                         window.location.href='<?=base_url('Settings/CustomerManagement/deletePerson/'.$customerid.'/')?>'+id;
