...
$pageBack=base_url()."Settings/CustomerManagement/";
    $addPerson=base_url()."Settings/CustomerManagement/addPerson/";
    $addPage=base_url()."Settings/CustomerManagement/add/";
    $deletePage=base_url()."Settings/CustomerManagement/Delete/";
    $addButton="Add";
    ...
    <div id="main">
        ...
        <section id="content_wrapper">
            ...
            <header id="topbar">
                ...
                <?php  if (check_role_assigned('customer','add')) {?>
