            ...
            border-bottom: solid 1px lightgray;
                        ...
                        <table style="border-style: solid; border-width: 0 1px 1px 1px; border-color: lightgray; font-size:16pxfont-family: Calibri;border-spacing: 2px;font-size:16px" cellspacing="0" cellpadding="0" class="table-2" width="100%">
                            <tr>
                                ...
                                <b>Narration: &nbsp; </b>SUPREME International having REX reg nº INREX2408004781EC006 of the products covered by this document declares that, except where otherwise clearly indicated,these products are <br/>of India preferential origin according to rules of origin of the generalizad system of <br/>preferences of the european union and that the origin criterion met is "P".
                                </td>
                            </tr>
                            <tr>
