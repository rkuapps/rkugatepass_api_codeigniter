...
$PageSave = base_url() . "GatePass/save";
$pageBack = base_url() . "GatePass/";
$operation = "Add";
$saveItem = base_url() . "GatePass/saveItem";
$addItem = base_url() . "Item/add/";
$getItemUnit = base_url() . "GatePass/getItemUnit";
$deleteItem = base_url() . "GatePass/deleteItem";
$DeleteDocument = base_url() . "GatePass/deleteDocument/" . $id;
$getItemData = base_url() . "GatePass/SingleItem/" . $id . "/";
$getCurrency = base_url() . "GatePass/getCurrency/";
$getQuotation = base_url() . "GatePass/getQuotation/";
            ...
            <header id="topbar">
                <div class="topbar-left">
                    <ul class="nav nav-list nav-list-topbar pull-left">
                        <li class="active ">
                            <a href="<?= base_url('Order') ?>">GatePass Form</a>
                        </li>
                    </ul>
                </div>
            </header>
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <ul class="nav panel-tabs-border panel-tabs  panel-tabs-left">
                                <li class="active">
                                    <a href="#order_from" data-toggle="tab" aria-expanded="false">GatePass Details</a>
                                </li>
                            </ul>
                        </div>
