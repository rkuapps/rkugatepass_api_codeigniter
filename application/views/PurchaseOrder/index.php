...
$pageBack=base_url()."PurchaseOrder/";
    $addPage=base_url()."PurchaseOrder/add/";
    $planpage=base_url()."PurchaseOrder/plan/";
    $deletePage=base_url()."PurchaseOrder/Delete/";
    $addButton="Add";

    $PrintPage=base_url()."PurchaseOrder/Print/";
                    ...
                    <div class="panel panel-visible" id="spy3">
                        <div class="panel-heading">
                            <div class="panel-title hidden-xs">
                                <span class="glyphicon glyphicon-tasks"></span>Purchase Order</div>
                        </div>
