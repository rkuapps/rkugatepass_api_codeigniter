...
$pageBack=base_url()."HRMS/Role/";
    $addPage=base_url()."HRMS/Role/add/";
    $deletePage=base_url()."HRMS/Role/Delete/";
    $addButton="Add";
              ...
              $i=1;
                ...
                <td class="text-center"> <?php 
                  if (check_role_assigned('role', 'edit')) {
                      echo "<div class='btn-group'>".anchor($addPage . $post->id, '<i class="fa fa-edit"></i>', ['title'=>'Edit Role','class' => 'btn btn-warning btn-xs', 'style' => 'float:left; margin-right:5px; margin-top:1px;']);
                    echo '</div>';
                  }
                  if (check_role_assigned('role', 'delete')) {
                      echo '<div class="btn-group"><a href="#" onclick="javascript:deleteBox(' . $post->id . ')" title="Delete Role" class="btn btn-danger btn-xs cancel "><span class="fa fa-trash-o"></span></a>';
                    echo '</div>';
                  }
                  ?>
                </td>
