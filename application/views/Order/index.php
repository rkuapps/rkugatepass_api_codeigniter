...
$planpage = base_url() . "Order/plan/";
$deletePage = base_url() . "Order/Delete/";
$addButton = "Add";
$penddingqty = base_url() . 'Order/getPendingqty';
$PrintPage = base_url() . "Order/Print/";
$invoice = base_url() . "Invoice/save/";
                            ...
                            <div class="panel panel-visible" id="spy3">
                                <div class="panel-heading">
                                    <div class="panel-title hidden-xs">
                                        <span class="glyphicon glyphicon-tasks"></span>Sales Order
                                    </div>
                                </div>
