<?php
    ...
    $pageBack = base_url() . "HostelUsers/";
    $addPage = base_url() . "HostelUsers/add/";
    $planpage = base_url() . "HostelUsers/plan/";
    $deletePage = base_url() . "HostelUsers/Delete/";
    $addButton = "Add";
    $penddingqty = base_url() . 'HostelUsers/getPendingqty';
    $PrintPage = base_url() . "HostelUsers/Print/";
    $invoice = base_url() . "HostelUsers/save/";
    $ItemPage = base_url() . "HostelUsers/index/";
?>
<!DOCTYPE html>
<html>
                            ...
                            <div class="panel panel-visible" id="spy3">
                                <div class="panel-heading">
                                    <div class="panel-title hidden-xs">
                                        <span class="glyphicon glyphicon-tasks"></span>Hostel Users
                                    </div>
                                </div>
