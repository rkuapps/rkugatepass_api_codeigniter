...
$pageBack=base_url()."CompanyMaster/";
    $addPage=base_url()."CompanyMaster/add/";
    $deletePage=base_url()."CompanyMaster/Delete/";
    $addButton="Add Company Master";
              ...
              $i=1;
                ...
                <td class="text-center"> <?php 
                  if (check_role_assigned('company_master', 'edit')) {
                      echo "<div class='btn-group'>".anchor($addPage . $post->id, '<i class="fa fa-pencil"></i>', ['title'=>'Edit Company' ,'class' => 'btn btn-primary btn-xs', 'style' => 'float:left; margin-right:5px; margin-top:1px;']);
                    echo '</div>';
                  }
