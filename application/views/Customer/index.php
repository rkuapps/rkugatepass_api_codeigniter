              ...
              $i=1;
                ...
                <td class="text-center"> <?php 
                  ...
                  if (check_role_assigned('customer', 'edit')) {
                      echo "<div class='btn-group'>".anchor($addPage . $post->id, '<i class="fa fa-pencil"></i>', ['title'=>'Edit Customer','class' => 'btn btn-primary btn-xs', 'style' => 'float:left; margin-right:5px; margin-top:1px;']);
                    echo '</div>';
                  }
                  if (check_role_assigned('customer', 'delete')) {
                      echo '<div class="btn-group"><a href="#" onclick="javascript:deleteBox(' . $post->id . ')" title="Delete Customer" class="btn btn-danger btn-xs cancel "><span class="fa fa-trash-o"></span></a>';
                    echo '</div>';
                  }
                  ?>
                </td>
